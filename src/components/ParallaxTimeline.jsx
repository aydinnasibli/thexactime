...
export default function ParallaxTimeline() {
    ...
    return (
        <div className='mb-40' style={{ background: '#dfdfdf', }}>
            <div className='flex justify-center items-center '>
                <Parallax style={{ overflowX: 'scroll', msOverflowStyle: 'none', width: '50%', height: '30%', scrollbarWidth: 'none', borderRadius: '30px', }} className={styles.container} ref={parallax} pages={60} horizontal>
